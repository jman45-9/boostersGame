...
public partial class player : CharacterBody2D
{
	...
	public override void _Process(double delta)
	{
		...
		if (Input.IsActionPressed("boostFwd"))
		{
			...
			Velocity = new Vector2((float)(velocity * Math.Sin(Rotation)),(float)(-velocity * Math.Cos(Rotation))); //velocity is negiive bc it will go backward otherwise :)
			_inputReceived = true;
		}
